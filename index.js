...
>
  SEDIKIT PEMBERITAHUAN DARI SAYA: ›
  HALO BANG SAYA JACKTHEXBEC SALKEN INI SC JANGAN DI JUAL YAH MOHON MAAF JIKA AD YANG EROR/DEBUG,MOGA KALIAN SUKA DENGAN SC NYA,MOGA KALIAN SEHAT SELALU THANKS YANG UDH SUPPORT JACK><.
   SC FREE CREATE AND SHARED BY!
   -JACKTHEXBEC
...
const TOKEN = '7833245535:AAHnJoJvLj6jRM3iRiWT0J-7GD4EogU0XYs';  // Replace with your bot token
const OWNER_ID = '1498401058'; // Replace with your owner ID
...
const asciiArt = `
  ...
  WA GW JACK:6283827666602
  TELE:t.me/JACKTHEXBEC
